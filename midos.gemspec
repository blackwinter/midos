...
Gem::Specification.new do |s|
  ...
  s.licenses = ["AGPL-3.0"]
  s.post_install_message = "\nmidos-0.2.1 [2015-12-11]:\n\n* Changed Midos::Writer to insert key field at beginning of record.\n\n"
  s.rdoc_options = ["--title", "midos Application documentation (v0.2.1)", "--charset", "UTF-8", "--line-numbers", "--all", "--main", "README"]
